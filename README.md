...
[![Mastodon Follow](https://img.shields.io/badge/Mastodon-Follow-6364FF?style=for-the-badge&logo=mastodon&logoColor=white)](https://mastodon.social/@vashchylau)
...
[![Threads Follow](https://img.shields.io/badge/Threads-Follow-000000?style=for-the-badge&logo=threads)](https://www.threads.net/@vashchylau)
...
<p>
  ...
  <img src="assets/logos/hellofresh.svg" alt="HelloFresh" height="30">
</p>
...
- 🎙️ **[YV Podcast](https://yvpodcast.yvinsights.com/)** — the Rabbit Hole, out loud. Narrative tech storytelling in the spirit of Planet Money and Acquired.
...
- 💬 **[YV and Friends](https://discord.gg/RXy4CjsPrS)** — the back room where the Rabbit Holes happen out loud: startups, OSS projects, growth strategies, paywalls, argued over in real time.

It's still small enough that you walk in a regular. Pull up a chair before it gets loud.
...
- ⌨️ **[Colemak Keyboard Driver](https://github.com/digitalby/Colemak-Driver-Win)** — Pure C Windows kernel driver that adds [Colemak](https://en.wikipedia.org/wiki/Colemak) to any QWERTY machine.
...
- 🎺 **[Xcode Sad Trombone](https://github.com/digitalby/xcode-sad-trombone)** — Plays a wah-wah when your Xcode build fails. (WIP)
- 💧 **[glassmith](https://github.com/digitalby/glassmith)** — Forge iOS 26 Liquid Glass app icons from layered source. (WIP)
- ⌨️ **[CEE IPA Layout](https://github.com/digitalby/cee-ipa-layout)** — A Mac keyboard layout for typing the International Phonetic Alphabet. (WIP)
