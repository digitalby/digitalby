...
function renderBasicVariant(
  ...
  return [
    ...
    `  <text x="${W / 2}" y="${H / 2}" font-family="'Palatino Linotype', Palatino, 'Book Antiqua', serif" font-size="${fontPx}" font-weight="${FONT_WEIGHT}" fill="${theme.textColor}" text-anchor="middle" dominant-baseline="central" letter-spacing="-0.02em">yuryv.info</text>`,
  ].join('\n');
}
